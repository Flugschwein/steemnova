...
<table>
	<tbody>
		...
		<tr>
            <td><a class='tooltip_sticky' data-tooltip-content="<table><tr><th><a href='#' onclick='return Dialog.info($elementID)'>{$LNG.tech.901}</a></th></tr><tr><table><tr><td><img src='{$dpath}gebaeude/$elementID.{if $productionID >=600 && $productionID <= 699}jpg{else}gif{/if}'></td><td>{$LNG.shortDescription.$elementID}</td></tr></table></tr></table>">{$LNG.tech.$elementID}</a></td>
